...
// Brevo SMTP transporter (works on Render, unlike Gmail SMTP)
const transporter = nodemailer.createTransport({
  host: 'smtp-relay.brevo.com',
  port: 587,
  secure: false,
  auth: {
    user: process.env.BREVO_SMTP_LOGIN,     // from Brevo dashboard
    pass: process.env.BREVO_SMTP_PASSWORD   // from Brevo dashboard
  }
});
